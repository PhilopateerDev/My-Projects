...
# الترتيب في X هيكون: Area ثم Rooms ثم Bathrooms ثم Location
X = df.drop('price', axis=1)
y = df['price']

# --- تقسيم البيانات لتدريب واختبار ---
# بنسبه 80% للتدريب و 20% للاختبار و random_state=42
...
# الترتيب هنا: Area -> Rooms -> Bathrooms -> Location
